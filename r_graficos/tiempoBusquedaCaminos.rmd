...
tiemposBusquedaCamino$Estructura[tiemposBusquedaCamino$Estructura == "graphComp"] <- "Adjacency" #"Comprimido con índices"
tiemposBusquedaCamino$Estructura[tiemposBusquedaCamino$Estructura == "graphCompDense"] <- "Adjacency Dense"
tiemposBusquedaCamino$Estructura[tiemposBusquedaCamino$Estructura == "graphNativeFull"] <- "Triple"
tiemposBusquedaCamino$Estructura[tiemposBusquedaCamino$Estructura == "graphNativeFullDense"] <- "Triple Dense"
...
ggplot(tiemposBusquedaCamino, aes(x=Grupos, y=Aristas, color=Estructura)) + #fill=Estructura
  ...
  labs(title= "Aristas encontradas 60 segundos",
       ...
       y = "Aristas encontradas (log2)",
       x = "Cantidad de Entidades") +
  #
  theme(plot.title = element_text(hjust = 0.5)) +
  #+ theme(axis.text.x = element_text(angle = 90, hjust = 1, vjust = 0.5))
  scale_y_continuous(trans='log2', breaks = c(2^4, 2^7,2^10,2^13,2^16,2^19,2^22))
...
ggplot(tiemposBusquedaCamino, aes(x=Grupos, y=memArista, color=Estructura)) + #fill=Estructura
