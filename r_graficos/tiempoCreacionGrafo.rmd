...
dataCreacion$Estructura[dataCreacion$Estructura == "graphComp"] <- "Adjacency"
dataCreacion$Estructura[dataCreacion$Estructura == "graphCompDense"] <- "Adjacency Dense"
dataCreacion$Estructura[dataCreacion$Estructura == "graphNativeFull"] <- "Triple"
dataCreacion$Estructura[dataCreacion$Estructura == "graphNativeFullDense"] <- "Triple Dense"
