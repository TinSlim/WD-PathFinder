...
tiemposBusquedaVecino$Estructura[tiemposBusquedaVecino$Estructura == "graphComp"] <- "Adjacency"
tiemposBusquedaVecino$Estructura[tiemposBusquedaVecino$Estructura == "graphCompDense"] <- "Adjacency Dense"
tiemposBusquedaVecino$Estructura[tiemposBusquedaVecino$Estructura == "graphNativeFull"] <- "Triple"
tiemposBusquedaVecino$Estructura[tiemposBusquedaVecino$Estructura == "graphNativeFullDense"] <- "Triple Dense"
